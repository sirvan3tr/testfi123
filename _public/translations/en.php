...
define("MESSAGE_ACCOUNTYPE_EMPTY", "There was an error with account type! Please contact us for help!");
define("MESSAGE_USERFULLNAME_EMPTY", "Full name field was empty");
...
define("WORDING_REGISTRATION_FULLNAME", "Full name");
